...
**Python**: \
`PyTorch`, `Lightning`, `scverse`/`scanpy`, `scikit-learn`, `NumPy`, `Pandas`,  `Seaborn`, `matplotlib` and more\
\
**R**:\
...
`SLURM`, `SGE`, `Google Cloud`, `Scaleway`, `Microsoft Azure`, `Azure Blob Storage`, `AWS Cloud Storage` and more
